...
try {
    ...
    Write-Host "[ERROR] Python not found. Please install Python 3.10.1 to 3.12.8" -ForegroundColor Red
    exit 1
}
...
Write-Host "[OK] ml-agents-envs installed" -ForegroundColor Green

pip install -e .\ml-agents --quiet
Write-Host "[OK] ml-agents installed" -ForegroundColor Green
...
Write-Host ""
Write-Host "Installing ONNX export dependencies..."
