...
class BatchedInference:
    ...
    def __init__(self, policy: Any, max_batch_size: int = 128) -> None:
        self.policy = policy
        self.max_batch_size = max_batch_size
        self.pending_observations: List[Any] = []
        self.pending_agent_ids: List[str] = []

    def add_observation(self, agent_id: str, observation: Any) -> None:
...
def enable_profiling(enable: bool = True) -> None:
