...
class MLAgentsBenchmark:
    ...
    def benchmark_buffer_operations(
        self, buffer_size: int = 10000, num_iterations: int = 100
    ) -> BenchmarkResult:
        """
    ...
    def run_quick_benchmark(self) -> Dict[str, BenchmarkResult]:
        ...
        # Benchmark buffer operations
        self.benchmark_buffer_operations(buffer_size=1000, num_iterations=10)
    ...
    def compare_results(
        self, baseline_result: BenchmarkResult, optimized_result: BenchmarkResult
    ) -> Tuple[float, str]:
        """
...
def main():
    ...
    parser.add_argument("--config", type=str, help="Config file to benchmark")
