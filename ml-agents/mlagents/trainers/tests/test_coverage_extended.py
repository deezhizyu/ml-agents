...
class TestRewardSignalExtended:
    ...
    def test_extrinsic_reward_signal(self):
        ...
        settings = RewardSignalSettings(gamma=0.99, strength=1.0)
    ...
    def test_curiosity_reward_signal(self):
        ...
        settings = CuriositySettings(gamma=0.99, strength=0.01, encoding_size=256)
...
class TestEnvironmentParametersExtended:
    ...
    def test_parameter_randomization(self):
        ...
        settings = UniformSettings(min_value=0.0, max_value=1.0)
    ...
    def test_gaussian_sampler(self):
        ...
        settings = GaussianSettings(mean=0.5, st_dev=0.1)
    ...
    def test_constant_sampler(self):
        ...
        settings = ConstantSettings(value=1.0)
...
class TestBehaviorSpecExtended:
    ...
    def test_behavior_spec_creation(self):
        ...
        action_spec = ActionSpec(continuous_size=2, discrete_branches=())

        spec = BehaviorSpec(observation_specs=[obs_spec], action_spec=action_spec)
