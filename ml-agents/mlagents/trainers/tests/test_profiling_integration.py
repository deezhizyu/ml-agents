...
class TestProfilingOutput:
    ...
    def test_profiling_summary_generation(self):
        ...
        summary = {
            "inference_avg": sum(metrics["inference_times"])
            / len(metrics["inference_times"]),
            "update_avg": sum(metrics["update_times"]) / len(metrics["update_times"]),
            "total_calls": len(metrics["inference_times"])
            + len(metrics["update_times"]),
        }
...
class TestProfilingIntegration:
    ...
    def test_profiling_selective_measurement(self):
        ...
        measurements = {"inference": [], "update": [], "total": []}
