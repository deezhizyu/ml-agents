...
class TestTorchOptimizerRewardSignals:
    ...
    def mock_policy(self):
        ...
        policy.behavior_spec.action_spec = ActionSpec(
            continuous_size=2, discrete_branches=()
        )
...
class TestTorchOptimizerBC:
    ...
    def test_bc_module_creation(self, mock_policy):
        ...
        bc_settings = BehavioralCloningSettings(
            demo_path="dummy.demo", steps=10000  # Not actually loaded in this test
        )
...
class TestOptimizerEdgeCases:
    ...
    def test_empty_reward_signals(self, mock_policy):
        ...
        trainer_settings = TrainerSettings(
            trainer_type="ppo", hyperparameters=PPOSettings(), reward_signals={}
        )
